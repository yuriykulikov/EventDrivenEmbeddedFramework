...
typedef portBASE_TYPE (*pdCOMMAND_LINE_CALLBACK)( char *pcWriteBuffer, size_t xWriteBufferLen );

/*
 * Register the callback passed in.
 * Registering a command adds the command to the list of commands that are
 * handled by the command interpreter.  Once a command has been registered it
 * can be executed from the command line.
 */
portBASE_TYPE xCmdIntRegisterCommand(char * pgm_Cmd, char * pgm_CmdDesc, const pdCOMMAND_LINE_CALLBACK callBack);
