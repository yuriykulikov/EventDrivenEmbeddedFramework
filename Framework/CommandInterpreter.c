...
CommandLineInterpreter * CommandLineInterpreter_create() {
    CommandLineInterpreter *commandLineInterpreter = (CommandLineInterpreter*) pvPortMalloc(
            sizeof(CommandLineInterpreter));
...
/*-----------------------------------------------------------*/
void CommandLineInterpreter_register(CommandLineInterpreter *interpreter, char *pgm_Cmd, char *pgm_CmdDesc,
        Handler *handler, char what) {
    /* Create a new list item that will reference the command being registered. */
    xCommandLineInputListItem *pxNewListItem = (xCommandLineInputListItem*) pvPortMalloc(
            sizeof(xCommandLineInputListItem));
